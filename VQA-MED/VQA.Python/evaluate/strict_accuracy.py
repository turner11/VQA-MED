...
def main(predictions_path):
    ...
    vqa = VQA(df_predictions)
    vqaRes = None#vqa.loadRes(resFile, quesFile)

    # create vqaEval object by taking vqa and vqaRes
    vqaEval = VQAEval(df_predictions)  # n is precision of accuracy (number of places after decimal), default is 2
    ...
    evals = [quesId for quesId in vqaEval.evalQA if
             vqaEval.evalQA[quesId] < 35]  # 35 is per question percentage accuracy
    if len(evals) > 0:
...
if __name__ == '__main__':
    predictions_path = 'C:\\Users\\Public\\Documents\\Data\\2019\\submissions\\20190408_0506_45_with_class_weights_for_diagnosis\\predictions.hdf'
